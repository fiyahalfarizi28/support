...
<?php
    ...
    if($r->assign_date != NULL && $r->done_date == NULL) {
      $class_assign ="active";
      $title_assign = "RFP dengan No. $r->no_rfp sedang dikerjakan";
      if ($r->done_date != NULL ) {
        $class_assign ="done";
        $title_assign= "RFP dengan No. $r->no_rfp telah selesai dikerjakan";
      }
    } else {
      if ($r->receive_date != NULL && $r->assign_date == NULL)
      {
        $class_assign = "active";
    ...
    if($r->confirm_date != NULL) {
      ...
      $title_confirmed= "RFP dengan No. $r->no_rfp telah selesai dikerjakan, mohon konfirmasi penyelesaian";
    } else {
